...
const AD_SETS: AdSet[] = [
  {
    id: 'as-lightning-launch-ctv', name: 'Scene+ Summer — CTV :30', campaignId: 'sobeys-scene-summer-hero', campaignName: 'Scene+ Summer Activation — National Hero',
    channel: 'ctv', format: 'CTV :30', asset: 'scene-summer-hero-ctv-30s',
  ...
  {
    id: 'as-f150-built-tough-ooh', name: 'Weekly Flyer Spring — National OOH', campaignId: 'sobeys-flyer-spring', campaignName: 'Weekly Flyer — Spring Value',
    channel: 'ooh', format: 'Billboard', asset: 'flyer-spring-ooh-national',
  ...
  {
    id: 'as-mach-e-search-defense', name: 'Compliments vs No Name — Search Defense', campaignId: 'sobeys-compliments-defense', campaignName: 'Compliments Own-Brand Defense',
    channel: 'google-search', format: 'Responsive Search Ad', asset: 'compliments-vs-noname-rsa',
  ...
  {
    id: 'as-bronco-tiktok-ugc', name: 'Summer BBQ — TikTok Creator UGC', campaignId: 'sobeys-bbq-national', campaignName: 'Summer BBQ & Grilling — National',
    channel: 'tiktok', format: 'Short-Form Video', asset: 'bbq-creator-pack-q2',
  ...
  {
    id: 'as-explorer-family-search', name: 'Meat & Seafood — Conquest Search', campaignId: 'sobeys-meat-family', campaignName: 'Meat & Seafood — Family Tables',
    channel: 'google-search', format: 'Search', asset: 'meat-seafood-conquest-rsa',
  ...
  {
    id: 'as-escape-phev-izev-reel', name: 'Voilà E-Commerce — Reels', campaignId: 'sobeys-voila-growth', campaignName: 'Voilà E-Commerce — Growth',
    channel: 'instagram', format: 'Reels', asset: 'voila-growth-explainer',
  ...
  {
    id: 'as-transit-linkedin-fleet', name: 'Pharmacy & Wellness — LinkedIn Sponsored', campaignId: 'sobeys-pharmacy-wellness', campaignName: 'Pharmacy & Wellness',
    channel: 'linkedin', format: 'Sponsored Content', asset: 'pharmacy-wellness-v3',
  ...
  {
    id: 'as-lightning-bc-search', name: 'Scene+ West — Search & Meta', campaignId: 'sobeys-scene-west', campaignName: 'Scene+ Activation — West',
    channel: 'google-search', format: 'Search', asset: 'scene-west-rsa-v2',
  ...
  {
    id: 'as-lightning-on-search', name: 'Scene+ Ontario — Search (anomaly)', campaignId: 'sobeys-scene-ontario', campaignName: 'Scene+ Activation — Ontario',
    channel: 'google-search', format: 'Search', asset: 'scene-on-rsa-v1',
  ...
  {
    id: 'as-brand-q2-ctv', name: 'Sobeys Masterbrand "So Canadian" — CTV', campaignId: 'sobeys-brand-q2', campaignName: 'Sobeys Masterbrand — So Canadian Q2',
